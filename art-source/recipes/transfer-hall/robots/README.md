# TS-01 Character Recipes

Characters use the same reproducibility principle but are **not** forced into rigid SVG production geometry like modular environment assets.
...
- **PRIMUS embodiment** — final recipe not yet authored; may be a different asset class depending on final staging.

## Required character recipe contents

Each final body recipe must preserve:

- exact eight-view order `N | NE | E | SE | S | SW | W | NW`;
