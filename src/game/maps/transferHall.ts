...
block(14,5,[56,57,58,59],2);            // Kayo premium platform, 2x2
...
export const TRANSFER_HALL_MAP: TiledMapJson = {
  ...
  properties:[prop("floorId","transfer-hall","string"),prop("floorName","TS-01 · TRANSFER HALL","string"),prop("subtitle","MOCKUP RECOVERY · CORE & SLOT","string"),prop("objectiveDefault","ERKUNDE FAMILIE → TRANSFER → PRIMUS-ZUTEILUNG","string"),prop("objectiveAfterEnergy","ERKUNDE DEN TRANSFERBEREICH","string")],
