...
import { CharacterGroundingSceneFixture } from "./meta/CharacterGroundingSceneFixture";
import "./styles.css";
...
const groundingScene = runtimeParams.get("groundingScene") === "1";
...
const content = groundingScene
  ? <CharacterGroundingSceneFixture />
  : groundingFixture
...
if (!groundingFixture && !groundingScene && "serviceWorker" in navigator) {
