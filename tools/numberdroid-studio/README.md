...
**Checkpoints 2C and 3 are implemented candidates but remain not user-accepted.** Checkpoint 2C adds strict exact-slice V2 assets, owner-gated lifecycle, durable bounded asset proposals, schema v9, ordinal **Slice 1–64** labels, and a sanitized offline bundle. Checkpoint 3 adds room/hallway archetypes and immutable variants, exact-version layered placement, visible connector/clearance and intent editing, deterministic validation, owner-only validation/finalization/fork, schema v10, exactly 19 MCP tools/four resource templates with placement proposal as the only agent room mutation, and portable schema-v2 room round trips. On 2026-08-22 the user deferred the 2C walkthrough, authorized Checkpoint 3, and requested this combined 2C + 3 acceptance gate; implementation and automated evidence are not acceptance. PR #135 remains open, draft, and unmerged. Merge, release, providers, Numberdroid/runtime/repository export, materialization, and publication remain blocked. See the [2C candidate record](docs/CHECKPOINT_2C_STATUS.md), [Checkpoint 3 contract](docs/CHECKPOINT_3_CONTRACT.md), and [roadmap](docs/ROADMAP.md).
