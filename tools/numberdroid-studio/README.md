...
The agent-first A0.1–A0.4 contracts are integrated but not user-accepted. A1.0
now has an implemented, likewise unaccepted contract candidate for the accepted
exact-PNG crop operation only; it adds no persisted processing workflow or new
operation. See the [A1.0 status](docs/A1_0_STATUS.md).
...
| Area | Current status |
| --- | --- |
| Product contract | Checkpoints 1–4 user-accepted; Checkpoint 4.5, Checkpoint 5, A0.1–A0.4, and A1.0 remain implemented candidates without user acceptance |
