...
execution is deliberately **not claimed**. The selected Studio visual Actions
lane must execute and retain that evidence before this candidate can be handed
off as CI-green.
