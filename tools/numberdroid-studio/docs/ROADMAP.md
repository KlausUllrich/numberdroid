...
**Status: 2A user-accepted on 2026-08-21; 2B user-accepted on 2026-08-22 after the live walkthrough at head `309c24961f89389047db837471b2e434dd13e149`; 2C remains blocked pending separate authorization.** Draft PR #135 remains open, draft, and unmerged. Checkpoint acceptance does not imply merge, release, publication, provider, room, export, materialization, or 2C authority.
...
2B exit decision: **accepted by the user on 2026-08-22.** Frozen CI verification passes 109/109 Node tests. GitHub Actions run `32568108922` passed Studio job `97019592824` and root job `97019592908` under Chrome `151.0.7922.137`. Its valid 2B artifact is `9474639509`, 2,838,857 bytes, `sha256:86366bc207fe081effeb8825b7cc4586026654fbe1c83ce026e1e12e6fc7ebd8`, expiring `2026-09-05T10:40:37Z`. Both 1440×900 and 1060×900 observations prove unchanged passive refresh keeps the same DOM, focused `top=5`, local X321/Y417, and window position; necessary render produces exact y5/h621 geometry without losing scroll; poll ownership and stale identity are bounded; drag replacement is deferred until settlement with inspector/SVG agreement; close/reopen creates a new Fit instance at 0,0; runtime/network errors remain zero. The live walkthrough additionally proved a 12+ second passive refresh retained both axes, the focused `Top margin = 5` draft, and page position; save succeeded; preview reached `SUCCEEDED` 4/4 on attempt 1 with four distinct quadrants; commit reached `APPLIED` 4/4 on attempt 1 with four stable v1 slice heads; recut mapping worked; unsaved `X = 4`/remap vanished on close/reopen while saved `X = 3` and v1 heads remained; and a full service restart preserved the approved source, exact rectangles, applied job, v1 previews, Fit/no-jump state, and no duplication. The user explicitly deferred one nonblocking UX finding: future UI should present ordinal **Slice 1–64** labels primarily and the canonical slice ID secondarily/copyably. Failed run `32567878956` and artifact `9474582144` remain diagnostic only. PR #135 remains open, draft, and unmerged; 2C, merge, release, providers, rooms, export, materialization, and publication stay blocked pending separate authorization.
...
Exit decision: Checkpoint 2B cutting accuracy, job workflow, recut mapping, and persistence were accepted on 2026-08-22. Checkpoint 2C metadata vocabulary and asset browsing remain a separate future gate.
