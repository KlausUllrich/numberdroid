...
It exposed a bounded finding-ID collision in invalid Rooms. The repair and
clearer existing validation-tool instructions are under verification; no new
screen, permission or lifecycle transition is part of that block.
