...
test('CP4.5 Browser evidence physically opens Preview and proves alpha plus visible non-occupying overhang', async () => {
  ...
  assert.match(capture, /dirtyMutationGuard\.previewDisabled === true/);
  assert.match(capture, /dirtyMutationGuard\.draft\.saved\.voidCells\.length === 2 && dirtyMutationGuard\.draft\.displayed\.voidCells\.length === 3/);
